...
% The Higgs boson limits assume $\mathcal{B}(\PH \to \mathrm{S}\mathrm{S}=100\%$, and each $\Pl$ has an equal probability of being an electron or a muon.
...
\input{figures/results/pre_postfit_prediction_pulls}
...
\input{figures/results/pre_postfit_param_pulls}
