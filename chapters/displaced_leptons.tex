...
The Ohio State CMS group has previously performed two related searches for displaced leptons in the electron-muon final state: one in \SI{19.7}{\fb} of \SI{8}{\TeV} data and another in \SI{2.6}{\fb} of \SI{13}{\TeV} data \cite{displaced_leptons_run1, displaced_leptons_bing}. The search presented here is the most sensitive to date.\fxnote{what about run2 atlas? how do i cite the preprint?} Some of the most significant improvements include:
\begin{itemize}
    \itemsep0em
    ...
    \item adding a second signal interpretation\fxnote{mention higgs and sleptons when we add them}
...
\input{chapters/displaced_leptons/corrections}\fxnote{should corrections come before bg?}
