...
% one-paragraph overview (include map)
% accelerator chain (include acceleator complex figure)
% magnets (include dipole cross section figure)
% rf
% describe beam structure somewhere
% define luminosity somewhere
