\begin{table}
\noindent \centering{}
\topcaption{The electron tight ID requirements. They are identical to the tight cut-based ID from the egamma Physics Object Group, except we remove any requirements on $d_0$ or the longitudinal impact parameter ~\cite{egammaPOGtightID}. Only the electron ID in the barrel is relevant, given our electron $\abs{\eta}$ cut and ECAL gap veto.}
\label{e_tight_id}
\begin{tabular}{ll}
\hline
